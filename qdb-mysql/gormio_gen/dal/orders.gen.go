...
func newOrder(db *gorm.DB, opts ...gen.DOOption) order {
	...
	_order.Product = field.NewString(tableName, "product")
...
func (o *order) updateTableName(table string) *order {
	...
	o.Product = field.NewString(table, "product")
...
func (temp *order) GetInfosByIDs(ids []int32) ([]*model.Order, error) {
...
func (temp *order) GetInfoByID(id int32) (*model.Order, error) {
...
func (temp *order) GetInfosMapByIDs(ids []int32) (map[int32]*model.Order, error) {
	infos,err:= temp.Where(temp.ID.In(ids...)).Find()
	if err!=nil{
		return nil, err
	}
	m:=map[int32]*model.Order{}
	for _,v:=range infos{
		m[v.ID]=v
	}
	return m, nil
...
// GetInfosByOrderIDs DO NOT EDIT.
func (temp *order) GetInfosByOrderIDs(ids []int32) ([]*model.Order, error) {
	infos,err:= temp.Where(temp.OrderID.In(ids...)).Find()
	if err!=nil{
		return nil, err
	}
	return infos, nil
...
// GetInfoByOrderID DO NOT EDIT.
func (temp *order) GetInfoByOrderID(id int32) (*model.Order, error) {
	info,err:= temp.Where(temp.OrderID.Eq(id)).First()
	if err!=nil{
		return nil, err
	}
	return info, nil
...
// GetInfosMapByOrderIDs DO NOT EDIT.
func (temp *order) GetInfosMapByOrderIDs(ids []int32) (map[int32]*model.Order, error) {
	infos,err:= temp.Where(temp.OrderID.In(ids...)).Find()
	if err!=nil{
		return nil, err
	}
